...
public class E2TransmissionAnalogique {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Float[] amplitude = {-4.0f, 4.0f};
        SourceFixe src = new SourceFixe("01001101");
        TransmetteurParfait tx = new TransmetteurParfait();
        DestinationFinale dst = new DestinationFinale();
        Codeur cdr = new Codeur(Mode.RZ, 30, amplitude,false);
        Decodeur dec = new Decodeur(Mode.RZ, 30, amplitude,false);
        ...
        new VueCourbe(toFloatArray(codEmis), "Message émis par le codeur (signal analogique)");
