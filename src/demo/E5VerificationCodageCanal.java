...
public class E5VerificationCodageCanal {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SourceFixe src = new SourceFixe("1101");
        TransmetteurParfait tx = new TransmetteurParfait();
        DestinationFinale dst = new DestinationFinale();
        Codeur cdr = new Codeur(Mode.NRZ, 3, amplitude,true);
        Decodeur dec = new Decodeur(Mode.NRZ, 3, amplitude,true);
        ...
        Information<Float> b = tx.getInformationEmise();
